...
[![Gradle Plugin Portal](https://img.shields.io/badge/Plugin_Portal-v1.0.7-green.svg)](https://plugins.gradle.org/plugin/com.coditory.integration-test)
...
```
plugins {
  id 'com.coditory.integration-test' version '1.0.7'
}
```
