...
[![Gradle Plugin Portal](https://img.shields.io/badge/Plugin_Portal-v1.4.6-green.svg)](https://plugins.gradle.org/plugin/com.coditory.integration-test)
...
```gradle
plugins {
  id "com.coditory.integration-test" version "1.4.6"
}
```
